        ...
        if(message.content.includes(" ")){
            ...
            if(userID == "521115847801044993"){
                ...
                const splitEmbedEdited = new Discord.MessageEmbed()
                    .setTitle(`${userTag.tag}'s friends`)
                    .setDescription(`They have 1,000,000+ friends!`)
                    .setColor("0099ff")
                    .setFooter('Friends | Version ' + botVersion)
                ...
                const splitEmbedEdited = new Discord.MessageEmbed()
                    .setTitle(`${userTag.tag}'s friends`)
                    .setDescription(`They have ${friends} friends!`)
                    .setColor("0099ff")
                    .setFooter('Friends | Version ' + botVersion)
                const first = await message.channel.send(splitEmbed)
                function editMSG() {
            ...
            if(message.author.id === "521115847801044993"){
                const splitEmbed = new Discord.MessageEmbed()
                ...
                const splitEmbedEdited = new Discord.MessageEmbed()
                    .setTitle(`${message.author.tag}'s friends`)
                    .setDescription(`You have 1,000,000+ friends!`)
                    .setColor("0099ff")
                    .setFooter('Friends | Version ' + botVersion)
                const first = await message.channel.send(splitEmbed)
                function editMSG() {
